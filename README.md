...
<!-- TOC START -->
## Table of Contents
- [🎬 SwiftUI Animation Masterclass](#-swiftui-animation-masterclass)
...
- [✨ Key Features](#-key-features)
  ...
  - [👆 Gestures](#-gestures)
- [🎬 Animation Types](#-animation-types)
  - [Basic Animation Manager](#basic-animation-manager)
  - [Spring Animation Manager](#spring-animation-manager)
  - [Keyframe Animation Manager](#keyframe-animation-manager)
- [🔄 Transitions](#-transitions)
  - [Transition Manager](#transition-manager)
  - [State Transition Manager](#state-transition-manager)
- [👆 Gestures](#-gestures)
  - [Gesture Animation Manager](#gesture-animation-manager)
  - [Interactive Gesture Manager](#interactive-gesture-manager)
...
- [🔧 Configuration](#-configuration)
  - [Animation Masterclass Configuration](#animation-masterclass-configuration)
